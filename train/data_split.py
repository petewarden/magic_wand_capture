...
import json
import random
from data_prepare import write_json_file
...
if __name__ == "__main__":
  ...
  data = read_data("gesture_data_v2/all_data.json")
  train_data, valid_data, test_data = split_data(data, 0.6, 0.2)
  write_json_file(train_data, "gesture_data_v2/training_data.json")
  write_json_file(valid_data, "gesture_data_v2/validation_data.json")
  write_json_file(test_data, "gesture_data_v2/testing_data.json")
